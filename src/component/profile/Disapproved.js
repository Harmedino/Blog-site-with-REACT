  ...
  return (
    <div className={styles.listPage}>
      <div className={styles.listHeader}>
        ...
        <p>Posts that are pending review or were not approved.</p>
      </div>
      <div className={styles.grid}>
        ...
        {!pending && !fail && blogs.length === 0 && (
          <div className={styles.emptyState}>
            <h3>No disapproved posts</h3>
            <p>Great news — all your posts have been approved!</p>
          </div>
        )}
        {blogs.map((blog) => (
          <div className={styles.card} key={blog._id}>
            ...
            <div className={styles.cardBody}>
              <div className={styles.cardTop}>
                ...
                <span className={`${styles.statusBadge} ${styles.statusDisapproved}`}>Pending Review</span>
              </div>
              ...
              <div className={styles.cardFooter}>
                ...
                <Link to={`/more/${blog._id}`} className={styles.readLink}>View →</Link>
              </div>
            </div>
          </div>
        ))}
